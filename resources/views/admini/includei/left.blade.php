<aside class="sidebar-wrapper">
    ...
    <div class="textmenu">
        <div class="brand-logo">
            <img src=" {{asset('adminAsseti')}}/assets/images/brand-logo-2.png" width="140" alt=""/>
        </div>
        <div class="tab-content">
            ...
            <div class="tab-pane fade" id="category">
                <div class="list-group list-group-flush">
                    ...
                    <a href="{{route('company')}}" class="list-group-item"><i class="bi bi-envelope"></i>company</a>
                    <a href="{{route('subsidiary')}}" class="list-group-item"><i class="bi bi-envelope"></i>subsidiary</a>
                    <a href="{{route('add-product')}}" class="list-group-item"><i class="bi bi-envelope"></i>add-product</a>
                    <a href="{{route('manage-product')}}" class="list-group-item"><i class="bi bi-envelope"></i>manage-product</a>
                </div>
            </div>
